...
class BrengerDeltaCalculator:
    ...
    def compute(self) -> tuple[pd.DataFrame, float, bool]:
        ...
        return df_merged[[ "id", "buyer_country-seller_country", "cat_level_2_and_3", "weight", "price", "price_brenger", "Delta", "Delta_sum", "Invoice date", "Invoice number","Order ID"]], delta_sum, flag
